package com.nixo.osubox.Utils.View;
...
public class ZLPolygonView extends View {
    ...
    public ZLPolygonView(Context context, @Nullable AttributeSet attrs) {
        ...
        mInnerColor = a.getColor(R.styleable.ZLPolygonView_InnerColor, Color.parseColor("#EE5C4E"));
    ...
    private void init() {
        ...
        mTextHeight = dp2px(context,4);

        mPaint = new Paint();
        mPaint.setAntiAlias(true);
        mPath = new Path();
        mTextPaint = new TextPaint();
        mTextPaint.setColor(Color.parseColor("#EE5C4E"));
        mTextPaint.setStyle(Paint.Style.FILL);
        mTextPaint.setTextSize(dp2px(context,6));
    }
